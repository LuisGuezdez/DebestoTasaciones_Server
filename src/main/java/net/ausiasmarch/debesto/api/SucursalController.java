...
public class SucursalController {
    ...
    @PutMapping
    public ResponseEntity<Long> update(@RequestBody SucursalEntity oUsuarioEntity) {
        return new ResponseEntity<Long>(oSucursalService.update(oUsuarioEntity), HttpStatus.OK);
    }
    
    @PostMapping
    public ResponseEntity<Long> create(@RequestBody SucursalEntity oNewUsuarioEntity) {
        return new ResponseEntity<Long>(oSucursalService.create(oNewUsuarioEntity), HttpStatus.OK);
    }
}
