...
import net.ausiasmarch.debesto.exception.JWTException;

public class JwtHelper {

    private static final String SECRET = "HOLAHOLAasdfghjklHOLAHOLA";
    private static final String ISSUER = "DEBESTO";
    ...
    public static String generateJWT(String name, Long usertype, Long id_user) {
